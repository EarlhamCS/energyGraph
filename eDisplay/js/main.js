/*
	...
	Modified by Alex Seewald, April 2014 to use normalized data.
...
var data_file;
var buildingNum; //change this number as more buildings are added
var buildingColors = new Array( '#9c1c34','#0A22af', '#ff381a','#00ff00',
								'#009944','#50D8F1','#e9af32', '#E07628');
if ($('input[name="isNormalized"]:checked').val() == "normalized") {
	data_file = "line_chart.txt";
	buildingNum = 7;
	buildingColors.splice(1,1);
}
else {
	data_file = "raw_line_chart.txt";
	buildingNum = 8;
}	
var lineChartJSONData = jQuery.ajax({
	url: data_file, //name of data file on server.
	dataType: "json",
	async: false
	}).responseText;
